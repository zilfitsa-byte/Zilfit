...
OUT="tests/z_ux_handoff_from_json_output_v1.json"

python3 runtime/run_z_ux_handoff_from_json.py tests/z_ux_runtime_input_v1.json > "$OUT"
...
echo "Z_UX_HANDOFF_FROM_JSON_TEST_PASS"
