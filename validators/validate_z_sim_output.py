...
REQUIRED = [
    ...
    "approved_for_use","skills_used","test_scope","blockers",
    "risk_level","go_no_go","next_validation_step"
]
...
if len(sys.argv) != 2:
    fail("Usage: validate_z_sim_output.py file.json")
...
if data["agent_name"] != "Z-Sim":
    fail("agent_name must be Z-Sim")
